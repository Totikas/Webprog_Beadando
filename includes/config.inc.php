...
$fejlec = array(
	'cim' => 'Mozi Műsor Kereső',
	'motto' => 'A legjobb budapesti mozik egy helyen'
);

$lablec = array(
    'copyright' => 'Copyright '.date("Y").'.',
    'ceg' => 'Készítette: Jónás Péter (UL3T7C) és Tóth László Gergő (YH33PJ)'
);

// menun: array(nem_bejelentkezett_látja, bejelentkezett_látja)
$oldalak = array(
